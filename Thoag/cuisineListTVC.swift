...
class cuisineListTVC: UITableViewController {

    
    var cuisines = ["All Cuisines","Lebanese", "Italian", "Indian", "Seafood", "Cafe", "Saudi", "Kabsa", "Harissa", "Maqluba", "Saleeg", "Basbousa", "Markook", "Masgouf", "Kleicha", "Muhallebi", "Haneeth", "Mexican" ]
